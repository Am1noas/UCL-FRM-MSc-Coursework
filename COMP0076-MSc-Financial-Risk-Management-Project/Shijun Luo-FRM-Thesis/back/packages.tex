...
%\usepackage[latin1]{inputenc}% I annotated this because it may cause citation error
\usepackage[english]{babel}
%\usepackage{siunitx}% (SI) units package, currently not installed
...
\usepackage{hyperref} % insert link in output pdf
%\usepackage{ieeetr}
\usepackage{lipsum}
\usepackage{tikz-cd}
\usepackage{float}
